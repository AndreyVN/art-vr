...
const faqs = [
  {
    ...
    a: 'От 7 лет в сопровождении взрослых, от 14 лет самостоятельно. Рекомендуемый возраст для VR — от 10 лет. Для детских праздников мы подбираем специальные игры без насилия и с короткими раундами.',
  },
  {
  ...
  },
  {
    ...
    a: 'Нет, сменная обувь не нужна. Достаточно прийти в удобной одежде и закрытой обуви. Мы рекомендуем избегать каблуков и очень широких платьев для комфортной игры.',
  },
  {
    q: 'Сколько человек можно пригласить на день рождения/мероприятие?',
    a: 'До 20 человек одновременно: 10 в VR-зонах + до 10 в лаунж-зоне с PS5 и настолками. Если компания больше, можно договориться об ротации — пока одни играют, другие отдыхают.',
  },
];

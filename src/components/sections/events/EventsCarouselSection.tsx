...
const slides = [
  {
    ...
    text: 'Большой выбор детских игр без жестоких сцен: администратор объясняет правила простыми словами, подбирает короткие раунды и меняет активности, чтобы дети не уставали. Наш козырь — Minecraft и Roblox прямо в VR: до 10 детей играют в одном мире одновременно, такого в Омске больше нигде нет. Между VR-сессиями ждут PlayStation 5 и настольные игры, а в финале организуем торжественный вынос торта и поздравление именинника.',
  },
  {

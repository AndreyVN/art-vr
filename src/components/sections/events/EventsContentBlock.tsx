...
const features = [
  ...
  {
    title: 'Minecraft и Roblox в VR',
    text: 'Наше УТП в Омске: Minecraft и Roblox прямо в виртуальной реальности — до 10 человек в одном мире одновременно. Идеально для больших детских и подростковых компаний, такого больше нигде в городе нет.',
    badge: 'Только у нас',
    accent: '#22c55e',
  },
  {

...
const features = [
  ...
  {
    title: 'Игровая зона',
    text: '10 отдельных игровых зон позволяют одновременно играть нескольким компаниям, не мешая друг другу. В каталоге — более 70 игр: от хорроров до весёлых симуляторов.',
    badge: null,
    accent: '#2b7fff',
  },
  {
  ...
  },
  {
    ...
    text: 'Зоны работают на связке VR-шлем + мощный ПК. Актуальные видеокарты и процессоры — никаких лагов, фризов и долгих загрузок.',
    badge: 'Meta Quest 3S',
    accent: '#ff006b',
  },
  {
